...
| **02** | **👤 Active Directory Lab**               | Built and managed a Windows Server Active Directory environment; practiced user and group management, permissions, and basic domain administration. | [📂 View](IT-Support-Labs
/Active-Directory) |
